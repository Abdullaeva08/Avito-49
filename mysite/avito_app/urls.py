...
from .views import (UserProfileListAPIView, CategoryListAPIView, SubCategoryListAPIView,
                    ProductListAPIView, ReviewViewSet, UserProfileDetailAPIView,
                    ProductDetailAPIView, CategoryDetailAPIView, SubCategoryDetailAPIView,
                    RegisterView, CustomLoginView, LogoutView, CartAPIView, CartItemViewSet,
