...
from .models import (Category, UserProfile, SubCategory,
                     Product, ProductImage, Review, Cart,
...
class ProductListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id', 'product_img', 'get_avg_rating', 'get_count_people','product_img','price', 'subcategory']
...
class SubCategoryDetailSerializer(serializers.ModelSerializer):
    category = CategorySimpleSerializer()
    sub_products = ProductListSerializer(many=True)
    class Meta:
        model = SubCategory
        fields = ['subcategory_name', 'subcategory_image','category', 'sub_products']
...
class ProductDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        fields = ['id','product_review','product_img', 'price','description', 'article_number', 'product_type', 'video',
                  'updated_date', 'product_review']
